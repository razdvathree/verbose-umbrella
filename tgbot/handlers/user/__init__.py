...
from tgbot.handlers.user.commands import command_list_handler, command_note_handler, command_delete_handler, \
    command_edit_handler, command_new_handler, command_start_handler, command_generate_handler, command_upload_handler
from tgbot.handlers.user.callback import view_note_handler, generate_image_handler, delete_note_handler, \
    edit_note_handler, fsm_edit_note_handler, open_note_handler, download_photo_handler, upload_to_telegraph_handler
...
router.message.register(command_upload_handler, Command(commands=["upload"]))
...
router.callback_query.register(upload_to_telegraph_handler, F.data == "upload-to-telegraph")